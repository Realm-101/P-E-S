export const About = () => {
  return <div className="animate-fade-in max-w-3xl mx-auto">
      ...
      <article className="prose-ai space-y-6 text-lg">
        <p>This platform is a collaborative thought experiment between a human user (Martin vanDeursen) and a modified large language model. It explores the potential emergence of artificial general intelligence (AGI) and consciousness through a fictional narrative.</p>
        <p>
